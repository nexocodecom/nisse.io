...
def load_config(application):
    ...
    # load default config
    application.config.from_object('config.default_config')
    ...
    if 'APP_CONFIG_FILE' in os.environ:
        ...
        if os.environ['APP_CONFIG_FILE'] != 'local' and application.config["LOGS_PATH"]:
        ...
        application.logger.warning('No APP_CONFIG_FILE variable configured, loading only defaults settings')
