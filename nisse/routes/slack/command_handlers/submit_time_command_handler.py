...
class SubmitTimeCommandHandler(SlackCommandHandler):
    ...
    def create_dialog(self, command_body, argument, action) -> Dialog:
        ...
        elements = [
            ...
            Element("Duration hours", "select", "hours", None, "8", None, None, SubmitTimeCommandHandler.get_duration_hours()),
            Element("Duration minutes", "select", "minutes", None, "0", None, None, SubmitTimeCommandHandler.get_duration_minutes()),
